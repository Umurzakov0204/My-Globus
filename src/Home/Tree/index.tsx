...
import { Example } from "@blueprintjs/docs-theme/lib/esm";
import { ContextMenu2, Classes as Popover2Classes, Tooltip2 } from "@blueprintjs/popover2/lib/esm";
...
// const object = [
//     { id: 1, icon: "calendar", label: "Item 0" },
//     { id: 2, icon: "calendar", label: "Item 1" },
//     { id: 3, icon: "calendar", label: "Item 0" },
//     { id: 4, icon: "calendar", label: "Item 1" },
// ];
...
const INITIAL_STATE: TreeNodeInfo[] = [
    {
        ...
        label: (
            ...
            // onDragStart={(event) => dragStartHandler(event, object)} draggable={true}
            >
                Folder 0
            </ContextMenu2>
        ),
    ...
    },
    {
        ...
        childNodes: [
            { id: 1, icon: "calendar", label: "Item 0" },
            { id: 2, icon: "calendar", label: "Item 1" },
            { id: 3, icon: "calendar", label: "Item 2" },
            { id: 4, icon: "calendar", label: "Item 3" },
        ],
    },
    {
        id: 4,
        ...
        label: (
            <ContextMenu2 {...contentSizing} content={<div>Hello there!</div>}>
                <Tooltip2 content="foo" placement="left">
                    Folder 2
                </Tooltip2>
            </ContextMenu2>
        ),
    ...
    },
    {
        ...
        childNodes: [
            { id: 8, icon: "calendar", label: "Item 0" },
